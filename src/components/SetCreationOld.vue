<template>
    <div class="container">
            ...
            <div class="row"> 
                ...
                <h3 v-else  class="col">{{sets[$route.params.id-1].name}}</h3>
                <div class="col save">
            ...
            <form enctype='application/json'>
                ...
                <div v-else class="row">
                    ...
                    <div  class="col-4">
                        ...
                        <p class="desc"> {{sets[$route.params.id].description}}
                        </p>   
                    </div>    
                </div>
                <h4>Sale</h4>
                    ...
                    <div class="accordion" id="accordionSale">
                        <div v-for="sala in set" v-bind:key="sala">
                            <template  >
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div v-bind:key="type" v-for="type in sala.types"  > 
                                            ...
                                            <template v-for="machine in sala.machines">
                                                <div v-bind:key="machine" v-if="machine.type.name==type" class="row machSet">
                                                    <div class="col-4 machNome">
                                                        <p :id="'machN'+machine.id">{{machine.name}}</p>
                                                    </div>

                                                    <div class="col-4 onOff">
                                                        <div  class="custom-control custom-switch">
                                                            <input class="custom-control-input" type="checkbox" value="on" :id="'checkM'+machine.id" 
                                                           v-on:click="change(machine.id)" v-on:change="mod(sala.id, machine.id)" checked>
                                                            <label class="custom-control-label" :for="'checkM'+machine.id">on</label>
                                                        </div>
                                                    </div>
